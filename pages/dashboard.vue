...
<template>
    <OuterComponents>
        ...
        <div class="px-5 max-w-2xl min-w-lg flex-grow m-auto">
            <div class="w-full my-8 text-center font-sans font-bold !text-primary text-5xl">Chocochips Scouting</div>
                            ...
                            <div v-for="(event, index) in pastEvents" class="bg-gray-100 rounded-md">
                                <div class="my-2 p-2">
                                    ...
                                    <UButton
                                        ...
                                        :label="event.city + ', ' + event.state_prov + ', ' + event.country"
                                        :to="event.gmaps_url"
                                        target="_blank"
                                        variant="outline"
                                    />
                                    ...
                                    <UPopover
                                        v-if="teamEventData[index] != undefined && teamEventData[index].length != 0"
                                    >
                                        <div class="flex">
                                            <UButton
                                            ...
                                            <p class="my-auto mx-0.5 font-sans">
                                                {{ placeify(teamEventData[index].rank) }} Place with a Record of
                                                {{
