            ...
            <UCard class="max-w-xl mt-5 flex-grow">
                ...
                <UContainer :class="'flex bg-blue-100 p-5 rounded-sm outline outline-3 ' + winningTeamColor[1]">
                    <UInput v-model="selectedBlueTeams[0]" class="flex-1" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[0][0]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
                    <UInput v-model="selectedBlueTeams[1]" class="flex-1 ml-2.5" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[0][1]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
                    <UInput v-model="selectedBlueTeams[2]" class="flex-1 ml-2.5" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[0][2]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
                ...
                <UContainer class="mt-4 mb-4">
                    <div class="text-center">
                        <p v-if="winningPercentage != -1 && !isNaN(winningPercentage)" class="font-semibold">
                ...
                <UContainer :class="'flex bg-red-100 p-5 mt-4 rounded-sm outline outline-3 ' + winningTeamColor[0]">
                    <UInput v-model="selectedRedTeams[0]" class="flex-1" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[1][0]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
                    <UInput v-model="selectedRedTeams[1]" class="flex-1 ml-2.5" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[1][1]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
                    <UInput v-model="selectedRedTeams[2]" class="flex-1 ml-2.5" placeholder="Team #">
                        <template #trailing>
                            <span v-if="teamsFound[1][2]" class="text-red-400 dark:text-red-600 text-xs"
                                >not found</span
                            >
                        </template>
                    </UInput>
