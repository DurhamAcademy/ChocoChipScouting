...
const { data: tbaEventData, pending: tbaPending } = await useLazyFetch<Array<any>>(
                    ...
                    <template #defense>
                        <PromptedNote
                            ...
                            :questions="[
                                ...
                                ['Is this team at risk of causing fouls? If so, elaborate why.', 2],
                    ...
                    <template #offense>
                        <PromptedNote
                            ...
                            :questions="[
                                ...
                                ['If applicable, how did the driver make efforts to avoid opposing defense?', 2],
