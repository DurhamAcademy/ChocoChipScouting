class LocalRemoteDatabaseSyncHolder<Content extends {} = {}> {
    ...
    static databases: { attachments: LocalRemoteDatabaseSyncHolder<{ name: string; team: number | undefined; author: string }>; scoutingData: LocalRemoteDatabaseSyncHolder<{  }>; basic: LocalRemoteDatabaseSyncHolder<{}> } = {
    ...
    static locals: { attachments: PouchDB.Database<{ name: string; team: number | undefined; author: string }>; scoutingData: PouchDB.Database<{  }>; basic: PouchDB.Database<{}> } = {
    ...
    static remotes: { attachments: PouchDB.Database<{ name: string; team: number | undefined; author: string }>; scoutingData: PouchDB.Database<{  }>; basic: PouchDB.Database<{}> } = {
